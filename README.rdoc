...
Alwayshungry is a Yelp clone app that lets users make a profile, post restaurants, and comment on other restaurants. You can check it out [here](https://Alwayshungry-ryomablue.herokuapp.com/). Sign up, add some of your favorite restaurants, and discover new ones too!
...
(https://github.com/ryomablue/Alwayshungry/blob/master/app/assets/images/amelias.png)
